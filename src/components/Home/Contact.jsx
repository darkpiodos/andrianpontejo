...
export default function Contact() {
  return (
    <section className="relative w-full min-h-screen flex flex-col  px-4 md:px-0 py-10 md:py-20 gap-6 overflow-hidden bg-lightPrimary dark:bg-darkPrimary">
      <div className="text-center md:text-left  space-y-3 px-4 sm:px-4 md:px-10 md:space-y-6 md:mt-10 max-w-7xl  mx-auto my-auto">
        <div className="flex flex-col md:flex-row gap-8 md:gap-10 items-center">
          ...
          <div className="flex-1 flex flex-col gap-10">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={index}
                  className="px-3 py-1 md:py-2 text-sm md:text-lg rounded-full bg-darkAccent/10 text-darkAccent border border-darkAccent
          ...
          {/* Right Column */}
          <form className="flex-1 flex flex-col gap-4 text-lg w-full">
            <input
              type="text"
            ...
            dark:bg-lightPrimary/5 dark:text-lightPrimary dark:placeholder:text-lightPrimary/50 dark:focus:ring-lightAccent  focus:outline-none focus:ring-2"
            />
            <input
              type="email"
              placeholder="Email"
